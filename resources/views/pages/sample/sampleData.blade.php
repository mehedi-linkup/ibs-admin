    ...
    <div class="container-fluid">
        ...
        <div class="card my-3">
            <div class="card-header d-flex justify-content-between">
                ...
                <div class="float-end ms-auto mb-0 d-flex">
                    {{-- <button href="#" onclick="printDiv('ProductData')" style="padding: 0px 20px;font-size: 16px;" class="btn btn-dark btn-sm shadow-none"><i class="fa fa-print"></i> Print</button> &nbsp;&nbsp; --}}
            ...
            <form @submit.prevent="updateSampleData">
                <div class="modal-content" >
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <label for="inputEff" class="col-form-label pt-0 col-sm-3">Sent To Wash</label>
                                <div class="col-sm-9">
                                    @if (Auth::user()->id == 1)
    ...
    const app = new Vue({
        ...
        methods: {
            ...
            getSampleData() {
                ...
                .then(res => {
                    this.sampleDatas = res.data.filter(item => item.active == 1);
                    this.show = false;
                })
            },

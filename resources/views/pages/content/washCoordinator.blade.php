...
@section('title', 'Wash Coordinator List')
@section('main-content')
<main id="root">
    <div class="container-fluid">
        <div class="heading-title p-2 my-2">
            <span class="my-3 heading "><i class="fas fa-home"></i> <a class="" href="">Home</a> > Wash Coordinator</span>
        </div>
        <div class="card my-3">
            <div class="card-header d-flex justify-content-between">
                <div class="table-head"><i class="fas fa-table me-1"></i> Wash Coordinator List</div>
                @isset(Auth::user()->role->permission['permission']['wash_coordinator']['add'])
            ...
            <div class="card-body table-card-body">
                <table class="table table-bordered table-hover">
                    ...
                    @isset(Auth::user()->role->permission['permission']['wash_coordinator']['list'])
                    <tbody class="text-center">
                        <tr v-for="(item, i) in coordinators" :key="i">
                            ...
                            <td class="text-center">
                                @isset(Auth::user()->role->permission['permission']['wash_coordinator']['edit'])
                                ...
                                @endisset
                                @isset(Auth::user()->role->permission['permission']['wash_coordinator']['delete'])
        ...
        methods: {
            ...
            saveData() {
                ...
                if(this.coordinator.id != null) {
                    url = '/update_wash_coordinator';
                }
                else {
                    url = '/save_wash_coordinator';
            ...
            deleteCoordinator(id) {
                if (confirm('Are You Sure? You Want to Delete this?')) {
                    axios.post('/delete_wash_coordinator', {id: id})
                    .then(res => {
                        let r = res.data
                        alert(r.message);
                        this.getCoordinators();
